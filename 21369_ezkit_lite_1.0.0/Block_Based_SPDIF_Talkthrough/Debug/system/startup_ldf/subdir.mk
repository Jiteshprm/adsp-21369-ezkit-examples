...
system/startup_ldf/app_IVT.doj: ../system/startup_ldf/app_IVT.s
	...
	easm21k -file-attr ProjectName="Block_Based_SPDIF_Talkthrough" -proc ADSP-21369 -si-revision any -g -D_DEBUG -DCORE0 @includes-6c9d764ad2da0957903665c26c659aaa.txt -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_IVT.d" -o "$@" "$<"
...
system/startup_ldf/app_startup.doj: ../system/startup_ldf/app_startup.s
	@echo 'Building file: $<'
	@echo 'Invoking: CrossCore SHARC Assembler'
	easm21k -file-attr ProjectName="Block_Based_SPDIF_Talkthrough" -proc ADSP-21369 -si-revision any -g -D_DEBUG -DCORE0 @includes-6c9d764ad2da0957903665c26c659aaa.txt -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_startup.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
