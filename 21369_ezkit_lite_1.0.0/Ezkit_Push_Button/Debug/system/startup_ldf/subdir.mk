...
system/startup_ldf/app_IVT.doj: ../system/startup_ldf/app_IVT.s
	...
	easm21k -file-attr ProjectName="Ezkit_Push_Button" -proc ADSP-21369 -si-revision any -g -D_DEBUG -DCORE0 @includes-185e5f3317d731aa749f658fb115b2d4.txt -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_IVT.d" -o "$@" "$<"
...
system/startup_ldf/app_startup.doj: ../system/startup_ldf/app_startup.s
	@echo 'Building file: $<'
	@echo 'Invoking: CrossCore SHARC Assembler'
	easm21k -file-attr ProjectName="Ezkit_Push_Button" -proc ADSP-21369 -si-revision any -g -D_DEBUG -DCORE0 @includes-185e5f3317d731aa749f658fb115b2d4.txt -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_startup.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
