...
system/startup_ldf/app_IVT.doj: ../system/startup_ldf/app_IVT.s
	...
	easm21k -file-attr ProjectName="Digital_In_Analog_Out_With_SRC" -proc ADSP-21369 -si-revision any -g -D_DEBUG -DCORE0 @includes-f1d45245dc6bdf214ca29864a87779a8.txt -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_IVT.d" -o "$@" "$<"
...
system/startup_ldf/app_startup.doj: ../system/startup_ldf/app_startup.s
	@echo 'Building file: $<'
	@echo 'Invoking: CrossCore SHARC Assembler'
	easm21k -file-attr ProjectName="Digital_In_Analog_Out_With_SRC" -proc ADSP-21369 -si-revision any -g -D_DEBUG -DCORE0 @includes-f1d45245dc6bdf214ca29864a87779a8.txt -gnu-style-dependencies -MM -Mo "system/startup_ldf/app_startup.d" -o "$@" "$<"
	@echo 'Finished building: $<'
	@echo ' '
